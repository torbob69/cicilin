...
const STATUS_MAP: Record<string, { label: string; cls: string }> = {
  ...
  manual_review:  { label: 'Manual Review', cls: 'bg-orange-500/10 text-orange-400 border-orange-500/30' },
  not_required:   { label: 'Auto',          cls: 'bg-gray-500/10 text-gray-400 border-gray-500/30' },
  scoring:        { label: 'Scoring',       cls: 'bg-purple-500/10 text-purple-400 border-purple-500/30' },
}
